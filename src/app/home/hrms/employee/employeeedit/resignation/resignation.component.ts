...
export class ResignationComponent implements OnInit {
  ...
  getbyidlogic() {
    if (this.empIdRes.message == "success") {
      // this.toastr.infoToastr('you already applied for resignation,please wait for managerapproval ', 'Info', {
      //   showCloseButton: true,
      //   animate: 'slideFromRight'
      // })
  ...
  resignationGetByEmpId() {
    ...
    this.hrms.getByEmpIdResignation(req2).subscribe(re => {
      ...
      if ((this.empIdRes.message == 'no records found') && ((this.role == 'ROLE_MANAGER') || (this.role == 'ROLE_ADMIN') || (this.role == 'ROLE_HR')) && (localStorage.getItem('setUserRole') != 'true')) {
      ...
      // else if ((this.empIdRes.message == 'no records found') && (this.setUserRole == 'true') &&(localStorage.getItem('Role') == 'ROLE_MANAGER')||(localStorage.getItem('Role') == 'ROLE_ADMIN')||(localStorage.getItem('Role') == 'ROLE_HR') ) {

      //  this.applystatus=false

      // }
      // else if ((this.empIdRes.message == 'no records found') && ((localStorage.getItem('Role') == 'ROLE_MANAGER')||(localStorage.getItem('Role') == 'ROLE_ADMIN')||(localStorage.getItem('Role') == 'ROLE_HR') )) {
      //  swal('Resignation Not Yet Applied')

      //  }

      //  else if ((this.empIdRes.message == 'no records found') && ((localStorage.getItem('Role') == 'ROLE_BDM') )) {
      //   this.applystatus = false;
      //  }
      //  else if ((this.empIdRes.message == 'no records found') && ((localStorage.getItem('Role') == 'ROLE_USER') )) {
      //   this.applystatus = false;
      //  }
      //  else {
      //   this.applystatus = false;
