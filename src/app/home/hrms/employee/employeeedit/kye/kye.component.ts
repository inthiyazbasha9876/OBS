...
export class KyeComponent implements OnInit {
  ...
  constructor(private hrms: HrmsService, private dataservice: DataService, protected sanitizer: DomSanitizer, private ng2PicaService: Ng2PicaService,private authService: AuthService,private toast:NotificationService) {
    this.getEmpKye();
    this.getempdata();
...
//Update Passport Image
  ...
  acceptpass() {
    ...
    if (upAcess.kye[0].passport_status != false) {
  ...
  declinepass() {
    ...
    if (upAcess3.kye[0].passport_status != true) {
    console.log("enters")
...
console.log(upAcess1,"request")
    if (upAcess1.kye[0].aadhar_status != false) {
  ...
  declineAadhar() {
    ...
    if (upAcess4.kye[0].aadhar_status != true) {
  ...
  acceptpPan() {
    ...
    if (upAcess2.kye[0].pan_status != false) {
...
console.log(updateres2,"response")
  ...
  declinePan() {
    ...
    if (upAcess5.kye[0].pan_status != true) {
